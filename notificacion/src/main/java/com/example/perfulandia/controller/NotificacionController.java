...
import com.example.perfulandia.DTO.NotificacionUsuarioDTO;
import com.example.perfulandia.DTO.UsuarioDTO;
import com.example.perfulandia.assembler.NotificacionModelAssembler;
...
@RestController
@RequestMapping("/api/perfulandia/notificaciones")
@Tag(
    name = "NOTIFICACIÓN",
